...
import numpy as np
import random
from code4class_embedding.bert import Model, Config
import argparse
...
parser.add_argument("--data_dir", default="8class_data", type=str, help="The task data directory.")
...
def get_class_embedding(config, model, data_iter,device):
    #print("2222222222")
...
def get_question_embedding(sent,device,batch_size):
    config.device=device
    with torch.no_grad():
